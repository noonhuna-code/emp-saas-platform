          ...
          return (
            <button
              ...
              className={
                variant === "soft"
                  ? selected
                    ? "rounded-full border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-slate-950 shadow-[0_6px_18px_rgba(15,23,42,0.10)] ring-1 ring-sky-500/10 dark:bg-slate-950 dark:text-slate-50 dark:ring-sky-400/20"
                    : "rounded-full px-4 py-2 text-sm font-medium text-slate-500 transition hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-900 dark:hover:text-slate-100"
                  : selected
