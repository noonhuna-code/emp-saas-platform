    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      {modules.map((module) => {
        ...
        <Link
          ...
          href={module.href}
          className="group rounded-[22px] border border-slate-200/80 bg-white/92 p-4 shadow-[0_12px_28px_rgba(15,23,42,0.05)] transition hover:-translate-y-0.5 hover:border-sky-200 hover:shadow-[0_18px_40px_rgba(14,116,144,0.12)] dark:border-slate-800 dark:bg-slate-950/78 dark:hover:border-sky-500/30"
        >
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-2.5">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-[18px] border border-slate-200/80 bg-slate-50 text-slate-700 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100">
                ...
                <div className="space-y-1.5">
                  ...
                  <div>
                    <p className="text-[15px] font-semibold tracking-[-0.02em] text-slate-950 dark:text-slate-50">{module.title}</p>
                    <p className="mt-1.5 text-sm leading-5 text-slate-600 dark:text-slate-400">{module.description}</p>
                  </div>
                </div>
              </div>
              {module.metric ? (
                <span className="inline-flex rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
                  {module.metric}
                </span>
              ) : null}
            </div>
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {module.highlights.map((highlight) => (
                  <span
                    ...
                    className="inline-flex rounded-full border border-slate-200/80 bg-white px-2.5 py-1 text-[11px] font-medium text-slate-600 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300"
                  >
                    {highlight}
                  </span>
                ))}
            ...
            <div className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-sky-700 transition group-hover:text-sky-800 dark:text-sky-300 dark:group-hover:text-sky-200">
              Open module
