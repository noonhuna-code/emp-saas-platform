  ...
  return (
    <>
      <JsonLd
        data={[
          softwareApplicationSchema(
            "EMP Contact and Demo",
            "Contact page for demo requests, lead capture, and platform evaluation conversations.",
            "/contact"
          ),
          breadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "Contact and Book Demo", path: "/contact" }
          ]),
              ...
              <div className="rounded-[2rem] border border-slate-900/10 bg-slate-950 p-6 text-white shadow-[0_24px_80px_rgba(15,23,42,0.16)]">
                ...
                <div className="mt-5 grid gap-3">
                  {[
                    ...
                    "We tailor the product walkthrough around your operating model.",
        ...
        <div className="container">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-center">
            ...
            <PlatformSnapshot
              ...
              description="A guided product view that helps buyers understand what the demo will cover before the conversation starts."
      ...
      <RelatedSolutions
        ...
        title="Move from SEO landing pages into a tailored demo conversation."
