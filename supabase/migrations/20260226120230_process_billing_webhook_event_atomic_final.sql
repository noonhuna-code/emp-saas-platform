-- ============================================
-- Migration: 20260226120230_process_billing_webhook_event_atomic_final.sql
-- Purpose : Replay-safe webhook processing with strict verification fields
...
begin
  ...
  v_payment_provider := lower(nullif(trim(coalesce(p_payload_json ->> 'payment_provider', p_provider)), ''));
