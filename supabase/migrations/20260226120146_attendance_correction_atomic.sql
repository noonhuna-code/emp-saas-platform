-- ============================================
-- Migration: 59b_attendance_correction_atomic.sql
-- Purpose: Atomic approval wrapper for attendance corrections
-- Scope: New SECURITY INVOKER function only (no schema/RLS changes)
-- Non-destructive: YES
...
begin
  ...
  if v_rowcount <> 1 then
    raise exception 'Correction not pending or not found';
  end if;
