-- ============================================
-- Migration: 20260226120234_billing_overdue_scheduler_latest_invoice_guard.sql
-- Purpose : Drive overdue/past_due from latest invoice only (tenant timezone aware)
