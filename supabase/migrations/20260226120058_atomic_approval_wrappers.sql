-- ============================================
-- Migration: 59_atomic_approval_wrappers.sql
-- Purpose: Atomic approval wrappers for leave approvals and attendance corrections
-- Scope: New SECURITY INVOKER functions only (no schema/RLS changes)
-- Non-destructive: YES
...
begin
  ...
  if v_rowcount <> 1 then
    raise exception 'Leave request not pending or not found';
  end if;
