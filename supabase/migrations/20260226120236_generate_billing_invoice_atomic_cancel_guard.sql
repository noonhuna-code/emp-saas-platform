-- ============================================
-- Migration: 20260226120236_generate_billing_invoice_atomic_cancel_guard.sql
-- Purpose : Block invoice generation when cancellation requested and snapshot payment method
...
begin
  ...
  perform public.write_billing_audit_event(
    ...
    jsonb_build_object(
      ...
      'payment_method_snapshot', 'manual',
