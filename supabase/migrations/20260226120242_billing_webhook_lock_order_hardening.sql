-- ============================================
-- Migration: 20260226120242_billing_webhook_lock_order_hardening.sql
-- Purpose : Enforce subscription->invoice lock ordering in webhook processor
...
begin
  ...
  -- Lock subscription first to keep global lock order:
  -- subscription -> invoice across both webhook and manual paid flows.
  perform 1
  from public.company_subscriptions cs
  where cs.company_id = p_company_id
    and cs.id = v_subscription_id
  limit 1
  for update;
